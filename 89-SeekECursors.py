...
# readline() -> Função que lê o arquivo linha a linha (readline -> ler linha)
...
print(arquivo.closed)  # Verifica se o arquivo está aberta ou fechado -> False

# 3 - Fechar o arquivo
arquivo.close()

print(arquivo.closed)  # Verifica se o arquivo está aberta ou fechado -> True
