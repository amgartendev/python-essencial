...
- Decorator tem um sintaxe própria, usando "@" (Syntact Sugar / Açúcar Sintático)
...
# Decorators com Syntact Sugar (Açúcar Sintático)
...
# OBS: Não é código funcional, é apenas demonstrativo
