...
# Podemos definir um valor padrão oara caso não encontremos o objeto com a chave informada
...
# Podemos utilizar qualquer tipo de dado (int, float, string, boolean), inclusive listas, tuplas, dicionários, como chaves
# de dicionários.
...
# Desda forma, facilmente adicionamos ou removemos produtos no carrinho e em cada produto 
...
# Ele vai gerar para cada valor do iterável uma chave e irá atribuir a este chave o valor informado
