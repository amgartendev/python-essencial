...
Classes podem conter:
    ...
    lâmpada é 110 ou 220 volts, qual a cor da sua luz, qual é a sua luminosidade e etc.
...
OBS: Quando nomeamos nossas classe em Python utilizamos por convenção o nome com inicial em maiúscula.
Se o nome for composto, utiliza-se as iniciais de cada palavra em maiúsculo, todas juntas.
